...
export class Service{
    ...
    async get_music_ID(UserId){
      ...
      async update_link( {MusicID , Link} ){
        try {
            console.log("I am inside update appointment");
            return await this.databases.updateDocument(
                conf.appwriteDatabaseId,
            ...
            console.log("Appwrite serive :: updateMusic_Link :: error", error);
        }
    }

    async get_music_Link(UserId){
        // console.log(UserId);     
          try {
              const a = await this.databases.listDocuments(
                  conf.appwriteDatabaseId,
